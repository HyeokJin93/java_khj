...
public class ExeListEx1 {
	...
	public static void main(String[] args) {
		...
		list1.size(); // 들어간 크기 = 리스트 크기
		int arr1[] = new int[5]; // = 크기를 미리 정해놓음
		arr1[0] = 1;
		...
		//get()은 index번지에 있는 객체를 가져오는 기능
		//get()은 list에만 있고, set에는 없음
		...
		//remove(int index) : index번지에 있는 객체를 제거한 후 객체를 알려줌
