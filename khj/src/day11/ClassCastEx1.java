...
public class ClassCastEx1 {
	...
	public static void main(String[] args) {
		...
		P2 p1 = new P2();
		P2 p2 = p1;
		/* 상황에 따라서는 =을 기준으로 타입이 같지 않아도 자동으로 변환이 되어 사용할 수 있음
		...
		num = (int)num2;
		//클래스와 일치하는 객체를 저장하여 저장
		C2 c = new C2();
		P2 p = new P2();
		//자식클래스의 객체를 부모 클래스의 객체로 자동 형변환할 수 있다
		P2 parent1 = new C2();
		parent1.print();
		// C2를 이용하여 객체를 만들었지만 P2에는 hello메소드가 없기 때문에 호출 불가능
		//parent.hello();
		C2 child1 = new C2();
		P2 parent2 = child1;
		parent2.print();
		//부모 = 자식 은 가능 // 자식 = 부모 불가능
		...
		*/
		...
		P2 parent5 = new C2();
		//부모 객체가 자식 객체로 만들어져 있어서 명시적으로 형변환이 가능
