...
/*    -- abc123 회원이 아크 폭스터 패딩을 화이트색상에 s사이즈를 1개 구매
insert into `order` values('2021HNT001', 'abc123', 1, now(), 1, 159000, 결제완료);
UPDATE `shoppingmall`.`option` 
